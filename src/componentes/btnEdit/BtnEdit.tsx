function BtnEdit ({handleClick, height = '35px', width = '35px', color = '#39f'} : {handleClick: (value:unknown) => void, height?:string, width?:string, color?:string}) {
    return  <a className="btn mb-0" style={{height:height, width:width, marginBottom: 10, backgroundColor:color }} onClick={handleClick}>
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" style={{transform: 'translate(-20%, 0%)'}}>
